 ...
 */
public class PayTrafficFragment extends Fragment implements MainActivity.OnBackPressedListener {
    ...
    public static PayTrafficFragment newInstance(String param1, String param2) {
        PayTrafficFragment fragment = new PayTrafficFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_pay_traffic, container, false);
