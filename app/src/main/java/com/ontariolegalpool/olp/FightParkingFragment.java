 ...
 */
public class FightParkingFragment extends Fragment implements MainActivity.OnBackPressedListener {
    ...
    public static FightParkingFragment newInstance(String param1, String param2) {
        FightParkingFragment fragment = new FightParkingFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_fight_parking, container, false);
